...
# H1 model (mean & shift for nuisance parameters)

# running: nohup bash run_joint_fix_cosmo_H1.sh > nohup_H1_Dz_IA.out &
# output: nohup_H1_Dz_IA.out


# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ KV450
wd=/disks/shear15/ssli/CosmicShear/KV450_H1_Dz_IA
...
#    -p ../input/kv450_joint_fix_cosmo_H1.param \
#    -o $wd \
#    --conf ./kv450_cf.conf \
#    -N 10

# mpi MultiNest run
export OMP_NUM_THREADS=3 # the number of cores used for each chain
mpirun -np 8 python2.7 ../montepython/MontePython.py run \
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Planck
wd=/disks/shear15/ssli/CosmicShear/Planck_H1_Dz_IA
...
# python2.7 \
#    ../montepython/MontePython.py run \
#    -p ../input/Planck_joint_fix_cosmo_H1.param \
#    -o $wd \
#    --conf ./kv450_cf.conf \
#    -N 10
